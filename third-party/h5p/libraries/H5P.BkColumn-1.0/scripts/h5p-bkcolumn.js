H5P.BkColumn = (function (EventDispatcher) {
   ...
   */
  function BkColumn(params, id, data) {
    /** @alias H5P.BkColumn# */
    var self = this;
    ...
    var addRunnable = function (content, contentData) {
      ...
      container.classList.add('h5p-bkcolumn-content');

      // Grigory. BkSeparator should be used to set the margins between the elements vertically
    ...
    self.attach = function ($container) {
      ...
      // Add to DOM
      $container.addClass('h5p-bkcolumn').html('').append(wrapper);
    };
    ...
    /**
     * Get title, e.g. for xAPI when BkColumn is subcontent.
     *
     * @return {string} Title.
     */
    self.getTitle = function () {
      return H5P.createTitle((self.contentData && self.contentData.metadata && self.contentData.metadata.title) ? self.contentData.metadata.title : 'BkColumn');
    };
  ...
  BkColumn.prototype = Object.create(EventDispatcher.prototype);
  BkColumn.prototype.constructor = BkColumn;
   ...
   * @return {boolean}
   */
  BkColumn.isTask = function (instance) {
