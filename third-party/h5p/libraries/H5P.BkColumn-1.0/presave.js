...
/**
 * Resolve the presave logic for the content type BkColumn
 *
 * @param {object} content
 * @param finished
 * @constructor
 */
H5PPresave['H5P.BkColumn'] = function (content, finished) {
  var presave = H5PEditor.Presave;
  if (isContentInvalid()) {
    throw new presave.exceptions.InvalidContentSemanticsException('Invalid BkColumn Error');
  }
